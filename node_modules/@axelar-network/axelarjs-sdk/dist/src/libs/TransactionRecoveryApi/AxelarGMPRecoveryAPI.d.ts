import { AxelarRecoveryAPIConfig, EvmChain, EvmWalletDetails, AddGasOptions, GasToken, TxResult, QueryGasFeeOptions, ApproveGatewayError, GMPRecoveryResponse, AxelarTxResponse } from "../types";
...
export declare class AxelarGMPRecoveryAPI extends AxelarRecoveryApi {
    ...
    getEvmEvent(srcChainId: string, destChainId: string, srcTxHash: string, srcTxLogIndex: number | undefined): Promise<{
        commandId: string;
        eventResponse: EventResponse;
        success: boolean;
        errorMessage: string;
    ...
    findEventAndConfirmIfNeeded(srcChain: string, destChain: string, txHash: string, txLogIndex: number | undefined, evmWalletDetails: EvmWalletDetails): Promise<ConfirmTxSDKResponse>;
    ...
    manualRelayToDestChain(txHash: string, txLogIndex?: number | undefined, evmWalletDetails?: EvmWalletDetails, escapeAfterConfirm?: boolean): Promise<GMPRecoveryResponse>;
